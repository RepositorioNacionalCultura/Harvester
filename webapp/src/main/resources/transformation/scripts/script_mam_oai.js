function (data) {
    /**
     Museo de Arte Moderno file Script
     **/
    var doURL = "https://mam.inba.gob.mx/img/coleccion/";
    ...
    if (dcData) {
        ...
        if (dcData.infoGenColeccMuseo) {
            ...
            if (dcData.infoGenNotaColeccion && dcData.infoGenNotaColeccion.trim().length > 0) {
                reccollection.push(dcData.infoGenNotaColeccion.trim());
            }
...
//        }
        ...
        if (arrHolder.length === 0) {
            arrHolder.push("Museo de Arte Moderno");
        }
