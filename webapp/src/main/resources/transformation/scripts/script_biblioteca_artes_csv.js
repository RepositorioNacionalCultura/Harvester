function (data) {
    /**
     Biblioteca de las Artes CSV file Script
     **/
    var doURL = "https://mexicana.cultura.gob.mx/multimedia/BIBLIOTECA_DE_LAS_ARTES/";
...
//    
    ...
    if (arrHolder.length === 0) {
        arrHolder.push("Biblioteca de las Artes");
    }
